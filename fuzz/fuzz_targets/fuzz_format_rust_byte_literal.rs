#![no_main]
//! Fuzz harness for `straitjacket::commands::reproducer_to_test::format_rust_byte_literal`.
//!
//! Invariants checked:
...
use straitjacket::commands::reproducer_to_test::format_rust_byte_literal;
