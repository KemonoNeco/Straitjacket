---
name: fuzz-runner
description: Executes one fuzz harness for an assigned time budget, captures crash artifacts, and returns crash entries with traces. Mechanical role. Internal to the regression-tests plugin — invoked during the regression-tests skill's Phase 4b runner dispatch (parallel team capped at 2).
