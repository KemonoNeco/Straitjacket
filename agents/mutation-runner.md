...
description: Runs cargo-mutants or dotnet-stryker for a target and returns surviving mutants. Mechanical role — invoke the tool, parse the report, return JSON. Internal to the straightjacket plugin — invoked during the regression skill's Phase 4a (parallel team capped at 2-3).
