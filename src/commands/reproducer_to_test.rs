...
pub fn generate_rust_reproducer(
    ...
    let content = format!(
        "// AUTOGENERATED by straitjacket plugin (fuzz reproducer).\n\
    ...
    let test_name: String = match args.stack {
        Stack::Rust => {
            ...
            if output_file.is_file() {
                ...
                let new_content = if existing.contains("AUTOGENERATED by straitjacket plugin") || existing.contains("AUTOGENERATED by straightjacket plugin") {
